...
insert into tasks(task_id, tab_id, name, is_deleted, version, prev_id) values (1, 1, "first", false, 1, null);

insert into tasks(task_id, tab_id, name, is_deleted, version, prev_id) values (2, 1, "투두 첫번째", false, 1, 1);
update tasks set next_id = 2 where task_id = 1;

insert into tasks(task_id, tab_id, name, is_deleted, version, prev_id) values (3, 1, "투두의 두번째", false, 1, 2);
update tasks set next_id = 3 where task_id = 2;

insert into tasks(task_id, tab_id, name, is_deleted, version, prev_id) values (4, 1, "투두의 세번째", false, 1, 3);
update tasks set next_id = 4 where task_id = 3;

insert into tasks(task_id, tab_id, name, is_deleted, version, prev_id) values (5, 1, "last", false, 1, 4);
...
insert into tasks(task_id, tab_id, name, is_deleted, version, prev_id) values (6, 2, "first", false, 1, null);
update tabs set first_task_id = 6 where tab_id = 2;
insert into tasks(task_id, tab_id, name, is_deleted, version, prev_id) values (7, 2, "In Progress의 첫번째", false, 1, 6);
update tasks set next_id = 7 where task_id = 6;
update tabs set last_task_id = 4 where tab_id = 2;

insert into tasks(task_id, tab_id, name, is_deleted, version, prev_id) values (8, 2, "last", false, 1, 7);
update tasks set next_id = 8 where task_id = 7;
update tabs set last_task_id = 8 where tab_id = 2;